...
public class Tube {
    ...
    public Tube(float x) {
        ...
        this.bottomTube = new Texture("bottomtub.png");
        random = new Random();

        posTopTube = new Vector2(x, random.nextInt(FLUCTUACTION)+ TUBE_GAP + LOWEST_OPENING);
    ...
    public void reposition(float x) {
        posTopTube.set(x, random.nextInt(FLUCTUACTION)+ TUBE_GAP + LOWEST_OPENING);
